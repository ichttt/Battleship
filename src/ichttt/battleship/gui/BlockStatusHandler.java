...
public class BlockStatusHandler {
    ...
    private static List<Integer> tempBlockingX = new ArrayList<>();
    private static List<Integer> tempBlockingY = new ArrayList<>();
    private static List<Integer> blockingX = new ArrayList<>();
    private static List<Integer> blockingY = new ArrayList<>();
    ...
    private static boolean checkIfBlocked(int posX, int posY) {
        ...
        for (int i = 0; i < blockingX.size(); i++) {
            if (blockingX.get(i).equals(posX) && blockingY.get(i).equals(posY)) return false;
        }
        return true;
    }
